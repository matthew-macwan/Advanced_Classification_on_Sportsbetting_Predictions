...
* One positive about trees compared to other machine learning algorithms is its ability to be          explained and understood by people who are not data scientists. The plot of the decision tree shows      where each node was split and at what value, ultimately leading to the terminal nodes of an Over or   Under decision. 
...
In order to be profitable in sports betting, we need to have a prediction accuracy of at least 55% since the books price bets in a way where the house always make money. 
